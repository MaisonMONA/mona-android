    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(comm()){
                ...
                FirstActivity.getDb().getUserDao().insertAll(user);
                return true;}
            else return false;
...
/*
        ...
        protected boolean comm() {
            ...
            try {
                url = new URL(
                        "http://www-etud.iro.umontreal.ca/~beaurevg/ift3150/server/?request=createUser&username="+
                                username+
                                "&password=1234");
